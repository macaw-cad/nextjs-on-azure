...
${components.map((component) => `import * as ${component.moduleName} from '${component.path}';`).join("\n")}

const components = new Map();
${components.map((component) => `components.set('${component.componentName}', ${component.moduleName});`).join("\n")}
