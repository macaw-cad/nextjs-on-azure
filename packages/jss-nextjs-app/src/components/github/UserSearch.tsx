import { Field, useComponentProps, GetStaticComponentProps } from "@sitecore-jss/sitecore-jss-nextjs";
...
const UserSearch: React.FC<UserSearchProps> = ({ fields, rendering }): JSX.Element => {
  ...
  return (
    <div data-e2e-id="graphql-connected">
      ...
      <p>
        Currently using this organization: <strong>{fields.searchTerm.value.replace(/\s+/g, "")}</strong>
      </p>
