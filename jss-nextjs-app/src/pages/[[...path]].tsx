...
const SitecorePage = ({ 
  ...
  if (!layoutData) {
    return (
      <>
        !layoutData {JSON.stringify(layoutData, undefined, 2)}<br />
        componentProps {JSON.stringify(componentProps)} <br />
  ...
  return (
    ...
    <>
      path {JSON.stringify(layoutData, undefined, 2)}
...
export const getStaticPaths: GetStaticPaths = async (
  ...
  if (process.env.NODE_ENV !== 'development') {
    ...
    //   {"params":{"path":["styleguide2","custom-route-type"]},"locale":"en"}
    // ]
